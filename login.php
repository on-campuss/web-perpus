	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<!-- start: LOGIN BOX -->
				<div class="box-login">
					<h3 align=center>Login Perpustakaan Daerah</h3>
					<p>
						...
						<fieldset>
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-green pull-right">
								 ...
								 <a href="lihat.php"><button type="button" class="btn btn-primary" name="tampil" id="tampil" >Lihat Buku</button></a></td>
							</div>
							<div class="new-account">
								Belum Punya Akun Perpus?
								<a href="ver_lihat.php" class="register">
							Bikin Akun Disini
								</a>
							</div>
						</fieldset>
				...
				<div class="box-register">
					<h3 align=center>Daftar Anggota Perpus</h3>
					<p>
						Masukan Data Anda...
					</p>
					<form class="form-register">
						...
						<br>
								...
								<div class="form-actions">
								Udah punya akun anggota Perpus?
