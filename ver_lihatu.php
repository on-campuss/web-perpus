							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title"> <span class="text-bold">Lihat Administrator</span> </h4>
									...
									<div class="panel-body">
										...
										<a href="ver_inputu"><button type="button" class="btn btn-light-azure">
										Add Administrator
											</button></a>
											</div>
										</div>
...
$sql_news="SELECT * 
from tb_login where level='admin'
";
$qry_news=mysql_query($sql_news,$konek)
or die ("gagal menampilkan".mysql_error());
while($hsl_news=mysql_fetch_array($qry_news)) {
$anggota=$hsl_news['kd_anggota'];
$nim=$hsl_news['nim'];
$nama=$hsl_news['nama'];
$progdi=$hsl_news['progdi']; 
?>
													<tr>
													    <td><?php echo ++$no;?></td>
														<td><?php echo $hsl_news['username'];?></td>
														<td><?php echo $hsl_news['nidn'];?></td>
														<td><?php echo $hsl_news['nama'];?></td>
														<td><?php echo $hsl_news['jekel'];?></td>
														<td><?php echo $hsl_news['ttl'];?></td>
														<td><?php echo $hsl_news['alamat'];?></td>
														<td><?php echo $hsl_news['nohp'];?></td>
														<td>
																	<div class="btn-group">
												...
												<ul class="dropdown-menu" role="menu">
													<li>
														<a href="ver_ubahu.php?verubah=<?php echo $hsl_news['id_login'];?>">
															<i class="fa fa-pencil"></i> Edit
														</a>
													</li>
													<li>
														<a href="ver_deleteu.php?idhapus=<?php echo"$hsl_news[id_login]";?>" onClick="return warning();"> 
															<i class="fa fa-trash-o"></i> Delete
														</a>
													</li>
													<li>
														<a href="ver_ubahrsimpan.php?verubah=<?php echo $hsl_news['id_login'];?>">
