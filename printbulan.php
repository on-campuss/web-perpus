							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										...
										<form  name="" method="POST" action="printbul.php" target="_blank">
						  <div class="form-group">               
    </div>
    <div class="col-sm-3">
                    <select name="pilihon" class="form-control">
                              <option value="Januari">Pada Bulan Januari</option>
                              <option value="Februari">Pada Bulan Februari</option>
                              <option value="Maret">Pada Bulan Maret</option>
                              <option value="April">Pada Bulan April</option>
                              <option value="Mei">Pada Bulan Mei</option>
                              <option value="Juni">Pada Bulan Juni</option>
                              <option value="Juli">Pada Bulan Juli</option>
                              <option value="Agustus">Pada Bulan Agustus</option>
                              <option value="September">Pada Bulan September</option>
                              <option value="Oktober">Pada Bulan Oktober</option>
                              <option value="November">Pada Bulan November</option>
                              <option value="Desember">Pada Bulan Desember</option>
                        </select>     
                          
                          
    </div>  
         <div class="col-sm-2">
    <select name="tahunn" class="form-control">
                            <?php
...
<a href="printbul.php"><button type="submit" name="login" class="btn btn-danger">Cetak Laporan <i class="fa fa-arrow-circle-right"></i></button></a>
</form></br>
    ...
    <th width="41%">Nama</th>
    <th width="20%">Pinajm </th>
	<th width="20%">Kembali</th>
...
?>
	...
	<td><?php echo $tampil['kembali'];?></td>
												...
												<ul class="dropdown-menu" role="menu">
													<li>
														<a href="ver_ubah.php?verubah=<?php echo $tampil['kd_buku'];?>">
