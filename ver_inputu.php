							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title"> <span class="text-bold">Input Administrator</span></h4>
									...
									<div class="panel-body">
										<form action="ver_simpanu.php" method="post" enctype="multipart/form-data" name="form1" target="_self"  class="form-horizontal" role="form">
											...
											<div class="form-group">
												...
												ID
													...
													<span class="input-icon">
														<input type="text"  name="id_login" id="id_login" class="form-control">
