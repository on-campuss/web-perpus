							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										...
										<form  name="" method="POST" action="printd.php" target="_blank">
...
<a href="printd.php"><button type="submit" name="login" class="btn btn-danger">Cetak Laporan <i class="fa fa-arrow-circle-right"></i></button></a>
</form></br>
