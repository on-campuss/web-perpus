    ...
    die("Anda bukan admin");//jika bukan admin jangan lanjut
						...
						<ul class="main-navigation-menu">
							<li class="active open">
								...
								<a href="ver_lihat.php"><i class="fa fa-home"></i> <span class="title"> Buku </span><span class="label label-default pull-right ">LABEL</span> </a>
                                <a href="ver_lihata.php"><i class="fa fa-home"></i> <span class="title"> Anggota </span><span class="label label-default pull-right ">LABEL</span> </a>
								<a href="ver_lihatp.php"><i class="fa fa-home"></i> <span class="title"> Peminjaman </span><span class="label label-default pull-right ">LABEL</span> </a>
								</li>		
						</ul>
