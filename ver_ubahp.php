							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title"> <span class="text-bold">Pinjam Buku</span></h4>
...
$sql_news="SELECT * FROM peminjaman WHERE id_pinjam='$verubah'";
...
?>    
										...
										<form action="ver_ubahpsimpan.php" method="post" enctype="multipart/form-data" name="form1" target="_self"  class="form-horizontal" role="form">
											...
											<div class="form-group">
												...
												ID Pinjam
													...
													<span class="input-icon">
														<input type="text"  readonly value="<?php echo $verlifet['id_pinjam'];?>" name="id_pinjam" id="id_pinjam" class="form-control">
											...
											<div class="form-group">
												...
												Judul Buku
														...
														<div class="col-sm-5">
													<span class="input-icon">
														<input type="text"   value="<?php echo $verlifet['judul'];?>" name="judul" id="judul" class="form-control">
 									...
 									<div class="form-group">
												...
												Tanggal Pinjam
														...
														<div class="col-sm-5">
													<span class="input-icon">
														<input type="text" name="pinjam" id="pinjam" class="form-control" value="<?php echo $verlifet['pinjam']; ?>">
														 </span>
												</div>
														</div>
										...
										<div class="form-group">
												...
												Tanggal Kembali
														...
														<div class="col-sm-5">
													<span class="input-icon">
														<input type="text" name="kembali" id="kembali" class="form-control" value="<?php echo $verlifet['kembali']; ?>">
														 </span>
												</div>
														</div>
