							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<a href="ver_inputa"><button type="button" class="btn btn-light-azure">
										Add Anggota
											</button></a>
											</div>
										</div>
...
?>
												...
												<ul class="dropdown-menu" role="menu">
													<li>
														<a href="ver_ubaha.php?verubah=<?php echo $hsl_news['kd_anggota'];?>">
															<i class="fa fa-pencil"></i> Edit
														</a>
													</li>
													<li>
														<a href="ver_deletea.php?idhapus=<?php echo"$hsl_news[kd_anggota]";?>" onClick="return warning();"> 
