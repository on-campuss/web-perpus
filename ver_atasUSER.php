...
<head>
		<title>Perpustakaan SMK WALISONGO</title>
		<!-- start: META -->
		<meta charset="utf-8" />
    ...
    die("Anda bukan admin");//jika bukan admin jangan lanjut
						...
						<ul class="main-navigation-menu">
							<li class="active open">
								...
								<a href="ver_lihatu.php"><i class="fa fa-home"></i> <span class="title"> User Administrator </span><span class="label label-default pull-right ">LABEL</span> </a>
								<a href="lihat.php"><i class="fa fa-home"></i> <span class="title"> Data Master Buku </span><span class="label label-default pull-right ">LABEL</span> </a>
								<a href="printbuku.php"><i class="fa fa-home"></i> <span class="title"> Laporan Buku Masuk </span><span class="label label-default pull-right ">LABEL</span> </a>
							<a href="printbulan.php"><i class="fa fa-home"></i> <span class="title"> Laporan Peminjaman Per Bulan </span><span class="label label-default pull-right ">LABEL</span> </a>
							<a href="printanggota.php"><i class="fa fa-home"></i> <span class="title"> Laporan Peminjaman Anggota </span><span class="label label-default pull-right ">LABEL</span> </a>
							<a href="printkem.php"><i class="fa fa-home"></i> <span class="title"> Laporan Buku Belum Kembali </span><span class="label label-default pull-right ">LABEL</span> </a>
							<a href="printjur.php"><i class="fa fa-home"></i> <span class="title"> Laporan Peminjaman Jurusan </span><span class="label label-default pull-right ">LABEL</span> </a>
							<a href="printden.php"><i class="fa fa-home"></i> <span class="title"> Laporan denda</span><span class="label label-default pull-right ">LABEL</span> </a>
							</li>		
						</ul>
						...
						<div class="toolbar row">
							<div class="col-sm-12 hidden-xs">
								<div class="page-header">
									<h1>PERPUSTAKAAN SMK WALISONGO</h1>
