							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Form <span class="text-bold">Lihat</span> Anggota</h4>
									...
									<div class="panel-body">
										...
										<a href="ver_lihatUSERa.php"><button type="button" class="btn btn-light-azure">
										Add Peminjam
											</button></a>
											</div>
										</div>
...
$judul=$hsl_news['judul'];
$nama=$hsl_news['nama'];
$pinjam=$hsl_news['pinjam'];
$kembali=$hsl_news['kembali']; 
?>
													<tr>
													    <td><?php echo ++$no;?></td>
				...
				?>
												...
												<ul class="dropdown-menu" role="menu">
													<li>
														<a href="ver_ubahp.php?verubah=<?php echo"$hsl_news[id_pinjam]";?>">
															<i class="fa fa-pencil"></i> Edit
														</a>
													</li>
													<li>
														<a href="ver_deletep.php?idhapus=<?php echo"$hsl_news[id_pinjam]";?>" onClick="return warning();"> 
