							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										...
										<form  name="" method="POST" action="printj.php" target="_blank">
						  <div class="form-group">               
    </div>
    <div class="col-sm-3">
                    <select name="pilihon" class="form-control">
                              <option value="Januari">Teknik Informatika</option>
                              <option value="Februari">Sistem Informasi</option>
                              <option value="Maret">Ekonomi</option>
                              <option value="April">PGSD</option>
                              <option value="Mei">Bahasa Inggris</option>
                              <option value="Juni">Manajemen</option>
                              <option value="Juli">Akutansi</option>
                              <option value="Agustus">Pertanian</option>
                              <option value="September">BK</option>
                              <option value="Oktober">Psikologi</option>
                        </select>     
...
<a href="printj.php"><button type="submit" name="login" class="btn btn-danger">Cetak Laporan <i class="fa fa-arrow-circle-right"></i></button></a>
</form></br>
