							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Ubah <span class="text-bold">Data Administrator</span></h4>
...
$verubah = '$_GET[id_login]';
$sql_news="select * from tb_login where id_login ='$_GET[verubah]'";
...
?>    
										...
										<form action="ver_ubahusimpan.php" method="post" enctype="multipart/form-data" name="form1" target="_self"  class="form-horizontal" role="form">
											...
											<div class="form-group">
												...
												ID
													...
													<span class="input-icon">
														<input type="text"  name="id_login" id="id_login" class="form-control" value='<?php echo $verlifet['id_login'];?>'>
												...
												Username
														...
														<div class="col-sm-5">
													<span class="input-icon">
														<input type="text"  name="username" id="username" class="form-control" value='<?php echo $verlifet['username'];?>'>
...
<div class="form-group">
												...
												Password
														...
														<div class="col-sm-5">
													<span class="input-icon">
														<input type="text"  name="password" id="password" class="form-control" value='<?php echo $verlifet['password'];?>'>
...
<div class="form-group">
      ...
      <option value="admin"<?php if($verlifet['level']=="admin"){echo"selected";} ?>>admin</option>
      <option value="user"<?php if($verlifet['level']=="user"){echo"selected";} ?>>user</option>
    </select></div>
												</div>														
